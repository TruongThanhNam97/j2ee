    ...
    <section class="container-fluid" id="main-body">
        <div class="row no-pad">
                            ...
                            <div class="col-md-8 profile-body-content-editing">
                                ...
                                <div class="overview-form">
                                  ...
                                  <form action="FrontController" method="post">
                                          ...
                                          <input required type="text" name="first-name" maxlength="30" value="${sessionScope.user.firstName}" />

                                          <label>Last Name:</label>
                                          <input required type="text" name="last-name" maxlength="30" value="${sessionScope.user.lastName}" />

                                          <label>Email/Mobile:</label>
                                          <input required type="text" name="mobile-or-email" value="${sessionScope.user.emailOrPhone}" />
            ...
            <div class="col-md-2 no-pad ahi">
                <%@include file="/WEB-INF/friend-list-1.jsp" %>
            </div>
        </div>
